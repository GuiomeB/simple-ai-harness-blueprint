...
| Run an activated autonomous loop (L+ only, ADR-gated) | (no capsule) | `AGENTS.md §Autonomy profile`, `.agents/workflows/loop.md`, `docs/adr/ADR-0002-lplus-autonomous-execution-profile.md`, `rules/sensitive-data.md`, `patterns/tiered-model-workflow.md` | `/loop` workflow |
